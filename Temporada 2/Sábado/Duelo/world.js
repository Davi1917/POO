...
let player1 = new Player('Alex', 5, 90, '#888888', 17, 15, bala1);

let player2 = new Player('Sandro', 8, 90, '#333333', 10, 12, bala2);
...
function playerVisual(player, x, y) {
    return Matter.Bodies.polygon(x, y, player.qntdLados, player.raio, {
        label: player.nome,
        isStatic: true,
        restitution: 0.5,
        render: {
